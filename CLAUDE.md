...
Это личный dotfiles репозиторий @dapi, который публично открыт.

Цель этого репозитория (далее - инфраструктура) иметь едину и централизованную систему настройки,
установки и обновления типовых утилит используемых @dapi в разработке.

Эта инфрастурктура испльзуется на десятке компьютеров с операционной системной
Linux Ubuntu и MacOS (Darwin)

Поэтому все механизмы установки, настройки и обновления в этом репозитории
создаются таким образом чтобы быть совместимыми между различными операционными
системами.

Категорически зарещается хардкодинг путей к файлам и каталогам.
